#
# $Id: showsblas.pl 21538 2011-11-16 22:56:50Z d3p852 $
#
...
# This script also prints the matching lines so you may see the 
# text that must be transformed for "single" precision computers.
#
# The script is envoked with the command:
#    perl showdblas.pl file1.f [file2.f ...]
#
