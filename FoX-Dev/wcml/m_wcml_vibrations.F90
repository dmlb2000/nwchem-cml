...
contains
  ...
  subroutine cmlAddMolecularVibrations_sp(xf, natoms, frequencies, eigenmodes, intensities)
    type(xmlf_t), intent(inout) :: xf
    integer, intent(in) :: natoms            
    real(kind=sp), intent(in)              :: frequencies(3*natoms)
    real(kind=sp), intent(in)              :: eigenmodes(9*natoms*natoms)
    real(kind=sp), intent(in), optional    :: intensities(3*natoms)
  ...
  end subroutine cmlAddMolecularVibrations_sp



  subroutine cmlAddMolecularVibrations_dp(xf, natoms, frequencies, eigenmodes, intensities)
    type(xmlf_t), intent(inout) :: xf
    integer, intent(in) :: natoms            
    real(kind=dp), intent(in)              :: frequencies(3*natoms)
    real(kind=dp), intent(in)              :: eigenmodes(9*natoms*natoms)
    real(kind=dp), intent(in), optional    :: intensities(3*natoms)
  ...
  end subroutine cmlAddMolecularVibrations_dp
