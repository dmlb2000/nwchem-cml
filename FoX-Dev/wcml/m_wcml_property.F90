...
contains
  ...
  subroutine propertyCmplxDpSca &
    (xf, value, dictRef, convention, title, id, ref, role, delimiter, units, fmt)
    ...
    if (present(delimiter)) call xml_addAttribute(xf, "delimiter", delimiter)
  ...
  subroutine propertyIntSca &
    (xf, value, dictRef, convention, title, id, ref, role, delimiter, units)
  ...
  subroutine propertyLgSca &
    (xf, value, dictRef, convention, title, id, ref, role, delimiter)
  ...
  subroutine propertyCmplxDpArrSi &
    (xf, value,nitems,  dictRef, convention, title, id, ref, role, delimiter, units, fmt)
  ...
  subroutine propertyIntArrSi &
    (xf, value,nitems,  dictRef, convention, title, id, ref, role, delimiter, units)
  ...
  subroutine propertyLgArrSi &
    (xf, value,nitems,  dictRef, convention, title, id, ref, role, delimiter)
  ...
  subroutine propertyCmplxDpMatSi &
    (xf, value,nrows, ncols,  dictRef, convention, title, id, ref, role, delimiter, units, fmt)
  ...
  subroutine propertyIntMatSi &
    (xf, value,nrows, ncols,  dictRef, convention, title, id, ref, role, delimiter, units)
  ...
  subroutine propertyLgMatSi &
    (xf, value,nrows, ncols,  dictRef, convention, title, id, ref, role, delimiter)
